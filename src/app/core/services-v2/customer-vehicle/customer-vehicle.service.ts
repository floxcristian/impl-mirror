...
export class CustomerVehicleService {
    ...
    getPaginatedCustomerVehicles(
        ...
        return this.http.get(`${API_CUSTOMER}/${documentId}/paginated-customer-vehicle`,{params:params})
    }
    ...
    createCustomerVehicle(
        ...
        return this.http.post(`${API_CUSTOMER}/${documentId}/customer-vehicle`,params)
    }
